        ...
        <div class="container">
          <div class="flex">
            ...
            <div class="flex items-center space-x-14 text-base capitalize">
              <a href="#" class="text-textcolor hover:text-primary transition">Home</a>
              <a href="#" class="text-textcolor hover:text-primary transition">Shop</a>
              ...
              <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-darkest rounded-lg shadow">
                  ...
                  <div class="p-6 space-y-6">
                    ...
                    <form method="post" action="rating_produk.php?id_order=<?php echo $_GET['id_order']; ?>">
