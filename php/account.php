  ...
  <body class="bg-darkest font-poppins">
    ...
    <div class="container lg:grid grid-cols-12 items-start gap-6 pt-52">
      ...
      <div class="col-span-3">
        ...
        <div class="px-4 py-3 shadow flex items-center gap-4 bg-dark">
          ...
          <div>
            ...
            <h4 class="text-white capitalize font-medium"></h4>
          </div>
        </div>
        <!-- account profile end -->
        ...
        <div class="mt-6 bg-dark shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
          ...
          <div class="space-y-1 pl-8">
            <a href="account.html" class="relative text-base font-medium capitalize hover:text-primary transition block text-primary">
              Manage account
          ...
          <div class="space-y-1 pl-8 pt-4">
            <a href="order-history.html" class="relative medium capitalize text-white font-medium hover:text-primary transition block">
              My order history
              <span class="absolute -left-8 top-0 text-base text-white">
      ...
      <div class="col-span-9 shadow rounded px-6 pt-5 pb-7 mt-6 lg:mt-0 bg-dark">
        <form action="">
          <h3 class="font-medium capitalize text-white text-center text-2xl">Profile Information</h3>
          <div class="">
            <div class="grid sm:grid-cols-2 gap-4">
              <div class="mt-6">
                <label class="block text-white" for="">First Name </label>
                <input type="text" placeholder="Enter First Name" class="text-white bg-dark w-full mt-2 px-4 py-3 border border-gray-200 focus:border-[#00ADB5] focus:bg-darkest focus:outline-none rounded-lg" />
              </div>
              <div class="mt-6">
                <label class="block text-white" for="">First Name </label>
                <input type="text" placeholder="Enter Last Name" class="text-white bg-dark w-full mt-2 px-4 py-3 border border-gray-200 focus:border-[#00ADB5] focus:bg-darkest focus:outline-none rounded-lg" />
              </div>
            </div>
            <div class="grid sm:grid-cols-2 gap-4">
              <div class="mt-6">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
              <div class="mt-6">
                <label class="block text-white" for="">Email Address </label>
                <input type="email" placeholder="Enter Email Address" class="text-white bg-dark w-full mt-2 px-4 py-3 border border-gray-200 focus:border-[#00ADB5] focus:bg-darkest focus:outline-none rounded-lg" />
              </div>
              <div class="mt-6">
                <label class="block text-white" for="">Phone Number </label>
                <input type="text" placeholder="Enter Phone Number" class="text-white bg-dark w-full mt-2 px-4 py-3 border border-gray-200 focus:border-[#00ADB5] focus:bg-darkest focus:outline-none rounded-lg" />
              </div>
            </div>
          </div>
          <div class="mt-6">
            <button
              type="submit"
              class="px-6 py-2 text-center text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 shadow-lg shadow-teal-500/50 rounded transition uppercase font-roboto font-medium"
            >
              Save changes
            </button>
          </div>
    ...
    <!-- footer start -->
    <footer class="bg-darkest pt-16 pb-12 mt-20 border-t">
      <div class="container">
