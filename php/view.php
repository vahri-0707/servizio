...
<html lang="en">
  ...
  <body class="bg-darkest font-poppins">
    ...
    <div class="container pt-48 pb-6 grid lg:grid-cols-2 gap-6">
          ...
          <div id="default-carousel" class="relative w-full" data-carousel="slide">
            ...
            <div class="relative w-full overflow-hidden rounded-lg md:h-96">
              ...
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="images/product2.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
              </div>
              <!-- Item 2 -->
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="images/product12.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
              </div>
              <!-- Item 3 -->
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="images/product3.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
              </div>
            </div>
            <!-- Slider indicators -->
      ...
      <!-- product content -->
      <div>
        <h2 class="md:text-3xl text-2xl font-medium uppercase mb-4 text-white">UI/UX Design</h2>
        <div class="space-y-4">
          ...
          <p class="space-x-2">
            ...
            <span class="text-gray-200">5 times</span>
          </p>
          <p class="space-x-2">
            <span class="text-white font-semibold">Category: </span>
            <span class="text-gray-200">Graphic Design</span>
          </p>
          <p class="space-x-2">
            <span class="text-white font-semibold">Delivery Time: </span>
            <span class="text-gray-200">3 Days</span>
          </p>
        </div>
        <div class="mt-4 flex items-baseline gap-3">
          <span class="text-primary font-semibold text-xl">Rp. 500.000,00</span>
        </div>
        ...
        <ul class="grid w-full gap-6 md:grid-cols-3">
          <li>
            <input type="radio" id="freelance1" name="freelance" value="freelance1" class="hidden peer" />
            <label
              for="freelance1"
              class="inline-flex items-center justify-between w-full h-24 p-5 text-white bg-dark border border-gray-400 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:text-primary hover:text-gray-200 hover:bg-gray-800"
            >
              <div class="block">
                <div class="w-full text-base font-semibold">John Doe</div>
                <a href="choose-freelance.html" class="w-full text-sm hover:underline hover:text-primary">View Detail</a>
              </div>
              <img src="images/freelance.jpg" alt="" class="w-10 h-10 object-cover rounded-full ml-3" />
            </label>
          </li>

          <li>
            <input type="radio" id="freelance2" name="freelance" value="freelance2" class="hidden peer" />
            <label
              for="freelance2"
              class="inline-flex items-center justify-between w-full h-24 p-5 text-white bg-dark border border-gray-400 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:text-primary hover:text-gray-200 hover:bg-gray-800"
            >
              <div class="block">
                <div class="w-full text-base font-semibold">Maul</div>
                <a href="#" class="w-full text-sm hover:underline hover:text-primary">View Detail</a>
              </div>
              <img src="images/freelance.jpg" alt="" class="w-10 h-10 object-cover rounded-full ml-3" />
            </label>
          </li>
          ...
          <li>
            <input type="radio" id="freelance3" name="freelance" value="freelance3" class="hidden peer" />
            <label
              for="freelance3"
              class="inline-flex items-center justify-between w-full h-24 p-5 text-white bg-dark border border-gray-400 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:text-primary hover:text-gray-200 hover:bg-gray-800"
            >
              <div class="block">
                <div class="w-full text-base font-semibold">Kevin</div>
                <a href="#" class="w-full text-sm hover:underline hover:text-primary">View Detail</a>
              </div>
              <img src="images/freelance.jpg" alt="" class="w-10 h-10 object-cover rounded-full ml-3" />
            </label>
          ...
          <div id="checkout" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
              ...
              <div class="relative bg-darkest rounded-lg shadow">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-dark hover:text-white rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="checkout">
                ...
                <div class="p-6">
                  ...
                  <ul class="my-4 space-y-3">
                    <li>
                      <input type="radio" id="payment1" name="payment" value="payment1" class="hidden peer" />
                      <label
                        for="payment1"
                    ...
                    <li>
                      <input type="radio" id="payment2" name="payment" value="payment2" class="hidden peer" />
                      <label
                        for="payment2"
                        class="inline-flex items-center justify-center w-full h-24 p-5 text-white bg-dark border border-gray-400 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:text-primary hover:text-gray-200 hover:bg-gray-800"
                      >
                    ...
                    <li>
                      <input type="radio" id="payment3" name="payment" value="payment3" class="hidden peer" />
                      <label
                        for="payment3"
                        class="inline-flex items-center justify-center w-full h-24 p-5 text-white bg-dark border border-gray-400 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:text-primary hover:text-gray-200 hover:bg-gray-800"
                      >
                    ...
                    <li>
                      <input type="radio" id="payment4" name="payment" value="payment4" class="hidden peer" />
                      <label
                        for="payment4"
                        class="inline-flex items-center justify-center w-full h-24 p-5 text-white bg-dark border border-gray-400 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:text-primary hover:text-gray-200 hover:bg-gray-800"
                      >
                              ...
                              <div id="small-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative w-full max-w-md max-h-full">
                                  ...
                                  <div class="relative bg-darkest py-8 rounded-lg shadow border border-gray-600">
                                    ...
                                    <div class="mt-10">
                                      <a href="order-history.html" class="bg-primary border border-primary text-white px-4 py-2 text-sm font-medium rounded-md uppercase hover:bg-transparent hover:text-primary transition text-center"
    ...
    <div class="container pb-16">
      ...
      <div class="lg:w-4/5 xl:w-3/5 pt-6">
        <div class="space-y-3 text-gray-200">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo, nesciunt pariatur! Laudantium maiores quas ipsa pariatur quae voluptatum impedit dolore repellat! Ratione dolorum natus excepturi assumenda expedita maiores vero
            dolore.
          </p>
          <p>
        ...
        <table class="table-auto border-collapse w-full text-left text-gray-200 text-sm mt-6">
          <tr>
            ...
            <td class="py-2 px-4 border border-gray-300">5 times</td>
          </tr>
          <tr>
            <th class="py-2 px-4 border border-gray-300 w-40 font-medium">Delivery Time</th>
            <td class="py-2 px-4 border border-gray-300">3 Days</td>
          </tr>
          <tr>
    ...
    <!-- related products -->
    <div class="container">
      <h2 class="text-2xl md:text-3xl font-medium text-white uppercase mb-6">our new arrival</h2>
      <!-- product wrapper -->
      <div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6">
        ...
        <div class="group rounded bg-dark shadow overflow-hidden" data-aos="fade-left" data-aos-duration="1000">
          ...
          <a
            href="#"
            class="block w-full py-1 text-center text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 shadow-lg shadow-teal-500/50 transition"
          >
            CHECKOUT
          </a>
          <!-- product button end -->
